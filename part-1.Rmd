...
In the next code chunk, we scrape a wikipedia table (actually many tables) and we split it into individual words, a process called *tokenizing*. 
...
We have acquired some different kinds of text from books and Wikipedia, did some data preparation (mostly cleaning), and some data extraction.
